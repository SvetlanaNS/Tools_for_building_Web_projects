...
function handleCalcDates(event) { 
    ...
    elseconsole.log("Для расчета промежутка необходимозаполнить все поля"); 
}
...
//export
 { Settings };
//export
 { Zone }; //# sourceMappingURL=luxon.js.map
...
dateCalcForm.addEventListener("result", handleCalcDates); 
...
function handleCalcDates(event) { 
  ...
  if (firstDate && secondDate) { 
   ...
   ("Для расчета промежутка необходимо заполнить все поля");
}
